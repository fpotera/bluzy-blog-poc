...
COPY backend/express/sequelize/index.js ./sequelize/
COPY backend/express/sequelize/extra-setup.js ./sequelize/
COPY backend/express/express/routes/* ./express/routes/
COPY backend/express/express/app.js ./express/
COPY backend/express/express/helpers.js ./express/
